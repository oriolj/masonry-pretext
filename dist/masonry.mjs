...
var require_masonry = __commonJS({
  "masonry.js"(exports, module) {
    ...
    (function(window2, factory) {
      ...
      Masonry2.version = true ? "5.0.0-dev.48" : "source";
      ...
      proto._create = function() {
        if (!hasLoggedBanner && !Masonry2.silent && !this.options.silent && typeof console !== "undefined" && console.info) {
      ...
      Masonry2.computeLayouts = function(opts, breakpoints) {
        var out = {};
        for (var i = 0; i < breakpoints.length; i++) {
          ...
          out[bp.name] = Masonry2.computeLayout(bpOpts);
        }
        return out;
      };
      return Masonry2;
