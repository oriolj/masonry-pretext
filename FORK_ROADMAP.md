...
| **T0.2** | **`package.json` `exports` / `module` / `types` fields + masonry.d.ts** | § 2.2 (partial — full ESM build still pending) | ✅ `v5.0.0-dev.11` | [011-tier0-foundation.md](./improvements/011-tier0-foundation.md) | full conditional exports + ~210-line stub d.ts; full ESM build is § 2.2 separate scope |
